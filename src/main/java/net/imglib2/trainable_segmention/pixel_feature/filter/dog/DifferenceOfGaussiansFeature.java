...
public class DifferenceOfGaussiansFeature extends AbstractFeatureOp {
	...
	private static void subtract(RandomAccessibleInterval<? extends RealType<?>> minuend, RandomAccessibleInterval<? extends RealType<?>> subtrahend, RandomAccessibleInterval<FloatType> target) {

...
public class SingleDerivativesFeature extends AbstractFeatureOp {
	...
	private void copy(RandomAccessibleInterval<? extends RealType<?>> source, List<RandomAccessibleInterval<FloatType>> target) {
		LoopBuilder.setImages(source, target.get(0)).forEachPixel( (i, o) -> o.setReal(i.getRealFloat()));
	}
}

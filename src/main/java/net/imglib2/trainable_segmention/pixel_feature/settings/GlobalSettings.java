...
public final class GlobalSettings {
	...
	private GlobalSettings(ChannelSetting channelSetting, int numDimensions, List<Double> radii, double scaleFactor) {
	...
	public GlobalSettings(GlobalSettings globalSettings) {
		this(globalSettings.channelSetting(), globalSettings.numDimensions(), globalSettings.radii(), globalSettings.scaleFactor());
	}

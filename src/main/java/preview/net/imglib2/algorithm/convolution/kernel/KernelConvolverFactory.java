package preview.net.imglib2.algorithm.convolution.kernel;
 ...
 * {@link preview.net.imglib2.algorithm.convolution.kernel.DoubleConvolverRealType}, {@link preview.net.imglib2.algorithm.convolution.kernel.FloatConvolverRealType},
 * {@link preview.net.imglib2.algorithm.convolution.kernel.ConvolverNativeType}, {@link preview.net.imglib2.algorithm.convolution.kernel.ConvolverNumericType}.
 *
...
public class KernelConvolverFactory implements LineConvolverFactory< NumericType< ? > >
{
	...
	private final preview.net.imglib2.algorithm.convolution.kernel.Kernel1D kernel;

	public KernelConvolverFactory( final preview.net.imglib2.algorithm.convolution.kernel.Kernel1D kernel )
	{
		this.kernel = kernel;
	}
	...
	private static final List< Entry > factories = Arrays.asList(
			new Entry( preview.net.imglib2.algorithm.convolution.kernel.DoubleConvolverRealType.class, RealType.class, DoubleType.class ),
			new Entry( preview.net.imglib2.algorithm.convolution.kernel.FloatConvolverRealType.class, RealType.class, RealType.class ),
			new Entry( preview.net.imglib2.algorithm.convolution.kernel.ConvolverNativeType.class, null, NativeType.class ),
			new Entry( preview.net.imglib2.algorithm.convolution.kernel.ConvolverNumericType.class, null, NumericType.class ) );

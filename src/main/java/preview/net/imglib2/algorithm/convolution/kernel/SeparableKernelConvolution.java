...
public class SeparableKernelConvolution
{
	 ...
	 * @see Convolution
	 */
	public static Convolution< NumericType< ? > > convolution( final preview.net.imglib2.algorithm.convolution.kernel.Kernel1D... kernels )
	{
	 ...
	 * @see Convolution
	 */
	public static Convolution< NumericType< ? > > convolution1d( final preview.net.imglib2.algorithm.convolution.kernel.Kernel1D kernel, final int direction )
	{
		return new LineConvolution<>( new preview.net.imglib2.algorithm.convolution.kernel.KernelConvolverFactory( kernel ), direction );
	}
	 ...
	 *            target image.
	 */
	public static void convolve( final preview.net.imglib2.algorithm.convolution.kernel.Kernel1D[] kernels,

 ...
 * {@link preview.net.imglib2.algorithm.convolution.LineConvolverFactory} on the given images.
 *
...
public class LineConvolution< T > implements Convolution<T>
{
	...
	public LineConvolution( final preview.net.imglib2.algorithm.convolution.LineConvolverFactory< ? super T > factory, final int direction )
	{
	...
	public void process( RandomAccessible< ? extends T > source, RandomAccessibleInterval< ? extends T > target )
	{
		...
		RandomAccessibleInterval< Localizable > positions = new Localizables().randomAccessibleInterval( new FinalInterval( dim ) );
